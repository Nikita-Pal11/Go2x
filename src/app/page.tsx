...
<<<<<<< HEAD
  ...
  return (
    <div className="fixed inset-0 bg-background flex flex-col items-center justify-center space-y-6 z-[200]">
      <motion.div
        animate={{ 
          scale: [1, 1.2, 1],
          rotate: [0, 10, -10, 0]
        ...
        className="w-20 h-20 bg-primary rounded-2xl flex items-center justify-center glow shadow-2xl shadow-primary/40"
      >
        <Zap className="text-white w-12 h-12 fill-white" />
      </motion.div>
      <div className="text-center">
        <h1 className="text-2xl font-black text-white italic tracking-tighter uppercase">Initializing Pioneer</h1>
=======
        router.push("/onboarding");
      } else {
        router.push("/dashboard");
